...
class MorseCodeEncryption {
    ...
    // Constructor to initialize the message and encrypt it
    public MorseCodeEncryption(String msg) {
        this.msg = msg;
        encryptMessage();
    }

    //Function to convert each letter to its sign in MorseCode
    public String Alphabet (char character)
    {
        character = Character.toUpperCase(character);
        ...
        switch (character) {
            ...
            case 'Y': return "-.--";
            case 'Z': return "--..";
            default: return ""; // Handle non-alphabet characters
        }
    }
    ...
    private void encryptMessage() {
        ...
        for (char character : msg.toCharArray()) {
            ...
            if (Character.isLetter(character)) {
                ...
                //Store the encrypted letters in empty string
                encryptedMsg += Alphabet(character) + " ";
        ...
        do{
            ...
            switch(Choice1){
                case 1 :
                    ...
                    System.out.println("[3] MorseCode Cipher");
                    ...
                    switch (Choice2){
                        ...
                        case 3 :
                            ...
                            // Applying MorseCode Cipher Encryption
                            System.out.println("Please Enter your Message to encrypt it:");
                            String message3 = input.nextLine();
                            //Creat Object From AtbashEncryotion Class
                            MorseCodeEncryption EncryptedMessageS = new MorseCodeEncryption(message3);
                            //use getter method to return the encrypted msg
                            System.out.println("The Encrypted Message is: " + EncryptedMessageS.getEncryptedMsg());
                            System.out.println("--------------------------------------------------------------------------");
                            break;
